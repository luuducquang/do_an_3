...
import { deleteCategoryOffer } from "../../service/categoryoffer.service";

type NotificationType = "success" | "info" | "warning" | "error";
const CategoryOfferDelete = (props: any) => {
    const [api, contextHolder] = notification.useNotification();
    const handleOk = async () => {
        props.handleCancelDeleteModal();
        await deleteCategoryOffer(props.listiddel);
        props.fetchData();
...
export default CategoryOfferDelete;
